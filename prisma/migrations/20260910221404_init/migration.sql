...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH_ON_DELIVERY', 'BANK_TRANSFER', 'CARD', 'LOCAL_GATEWAY');
...
-- CreateIndex
CREATE UNIQUE INDEX "HomepageSection_name_key" ON "HomepageSection"("name");
